...
public class MessageHub : Hub
{
    ...
    public override async Task OnConnectedAsync()
    {
        ...
        var messages = await _unitOfWork.MesageRepository.GetMessageThread(Context.User.GetUsername(), otherUser);
    ...
    public async Task SendMessage(CreateMessageDto createMessageDto)
    {
        ...
        var group = await _unitOfWork.MesageRepository.GetMessageGroup(groupName);
    ...
    private async Task<Group> AddToGroup(string groupName)
    {
        ...
        if (group == null)
        {
            ...
            _unitOfWork.MesageRepository.AddGroup(group);
        }
    ...
    {
        var group = await _unitOfWork.MesageRepository.GetGroupForConnection(Context.ConnectionId);
        var connection = group.Connections.FirstOrDefault(c => c.ConnectionId == Context.ConnectionId);
        _unitOfWork.MesageRepository.RemoveConnection(connection);
